...
ALTER TABLE Note ADD CONSTRAINT fk_NoteUserId FOREIGN KEY (userId) REFERENCES Account (id) ON DELETE CASCADE;
ALTER TABLE Note ADD CONSTRAINT fk_NoteBookId FOREIGN KEY (bookId) REFERENCES Book (id) ON DELETE CASCADE;
